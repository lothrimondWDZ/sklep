...
public class TshirtView extends JFrame {
	...
	public TshirtView(boolean addEditShow, String actionName, JTable tshirtTable, TShirtList tshirtList) {
		...
		int selectedRowIndex = tshirtTable.convertRowIndexToModel(tshirtTable.getSelectedRow());
				...
				.setHorizontalGroup(
						gl_contentPane
								...
								.addGroup(gl_contentPane.createSequentialGroup().addContainerGap()
										.addGroup(gl_contentPane.createParallelGroup(Alignment.TRAILING)
												...
												.addGroup(gl_contentPane.createSequentialGroup()
														.addGroup(gl_contentPane.createParallelGroup(Alignment.LEADING)
																.addComponent(lblNazwa).addComponent(lblCena)
																.addComponent(lblKolor).addComponent(lblMarka)
																.addComponent(lblMateria).addComponent(lblRozmiar)
										...
										.addGap(31))
								.addGroup(Alignment.LEADING, gl_contentPane.createSequentialGroup().addGap(188)
										.addComponent(lblKoszulki).addContainerGap(258, Short.MAX_VALUE)));
				...
				.addGroup(gl_contentPane.createSequentialGroup().addContainerGap().addComponent(lblKoszulki).addGap(18)
						...
						.addGroup(gl_contentPane.createSequentialGroup()
								...
								.addGroup(gl_contentPane.createParallelGroup(Alignment.BASELINE)
										.addComponent(lblRozmiar).addComponent(sizeComboBox, GroupLayout.PREFERRED_SIZE,
												GroupLayout.DEFAULT_SIZE, GroupLayout.PREFERRED_SIZE))
								.addGap(18)
