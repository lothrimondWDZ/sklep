...
public class MainView {
	...
	jacketPokaz.addMouseListener(new MouseAdapter() {
	    @Override
	    public void mouseClicked(MouseEvent e) {
		jacketFrame = new JacketView(false, "Przeglπdaj kurtke");
		jacketFrame.show();
	    }
	});
	...
	shirtPokaz.addMouseListener(new MouseAdapter() {
	    @Override
	    public void mouseClicked(MouseEvent e) {
		shirtFrame = new ShirtView(false, "Przeglπdaj Koszule");
		shirtFrame.show();
	    }
	});
	...
	tshirtPokaz.addMouseListener(new MouseAdapter() {
	    @Override
	    public void mouseClicked(MouseEvent e) {
		tshirtFrame = new TshirtView(false, "Przeglπdaj T-shirt");
		tshirtFrame.show();
	    }
	});
	...
	pantsPokaz.addMouseListener(new MouseAdapter() {
	    @Override
	    public void mouseClicked(MouseEvent e) {
		pantsFrame = new PantsView(false, "Poka≈º spodnie");
		pantsFrame.show();
	    }
	});
	...
	shoesPokaz.addMouseListener(new MouseAdapter() {
	    @Override
	    public void mouseClicked(MouseEvent e) {
		shoesFrame = new ShoesView(false, "Przeglπdaj buty");
		shoesFrame.show();
	    }
	});
